...
func (c *ConnectPacket) WriteTo(w io.Writer) error {
...
func (c *ConnectPacket) ReadFrom(r io.Reader) error {
	var err error
	...
	c.KeepaliveTimer, err = decodeUint16(r)
	if err != nil {
		return err
	}
	...
	if c.WillFlag {
		c.WillTopic, err = decodeString(r)
		if err != nil {
			return err
		}
		c.WillMessage, err = decodeBytes(r)
		if err != nil {
			return err
		}
	}
	if c.UsernameFlag {
		c.Username, err = decodeString(r)
		if err != nil {
			return err
		}
	}
	if c.PasswordFlag {
		c.Password, err = decodeBytes(r)
		if err != nil {
			return err
		}
	}
